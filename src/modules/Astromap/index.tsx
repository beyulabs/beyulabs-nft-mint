            ...
            <div className='container'>
                <div className={s.cards}>
                    ...
                    <div className={cn(s.card, s.card_2)}>
                        ...
                        >
                            <p>
                                It takes more than just grinding behind the
                                scenes to grow an ecosystem. Exclusive hybrid
                                experiences for crew members, layering the
                                physical and virtual worlds together to showcase
                                the community talent and network. Fusing both
                                worlds to rival even Web2.
                                <ul>
              ...
              alike.'
                        >
                            <p>
                                A bounty hub empowering freelancers, project
                                teams, and agencies alike. With the Web3 space
                                growing into countless sub-communities of
                                creators and thinkers, we are able to create a
                                flexible and secure system of opportunities and
                                relationships. Holders have priority access to a
                                marketplace of talent, powered by partnerships
                                and individual professionals who are invested in
                                the space (and its growth).
                                <ul>
                                    <li>
                                        Bounty Listing Unlock - [Early Access]
                                    </li>
                    ...
                    <div className={cn(s.card, s.card_4)}>
                        ...
                        >
                            <p>
                                When engineering this new world of web3 and
                                creating a business, not every vessel will reach
                                its final destination. The BeYu Labs Team is
                                here to guide you on your journey via project
                                advisory, consultations, and continued support
                                from ideation through project launch. A
                                navigation system to launch your own mission.
                                <ul>
                    ...
                    <div className={cn(s.card, s.card_5)}>
                        ...
                        >
                            <p>
                                A spotlight on some of our Holder&apos;s Top
                                Projects via Panels, Interviews, Podcast,
                                Collabs, and Dedicated Discord channels. We are
                                passionate about connecting crew members to
                                build innovative projects, and want to showcase
                                these projects to our community and partner
                                communities. A win for you is a win for all.
                                <ul>
                    ...
                    <div className={cn(s.card, s.card_6)}>
                        ...
                        >
                            <p>
                                A percentage of the mint will go to a Community
                                Chest to be re-invested as decided by our
                                Holders and the appointed Tribunal. The
                                possibilities are truly endless, and we believe
                                in bringing continued value to the community.
                                Some options include: investing into blue chip
                                projects, metaverse land, conferences, or
                                project teams that are incubated from our
                                ecosystem.
                                <ul>
                    ...
                    <div className={cn(s.card, s.card_7)}>
                        ...
                        >
                            <p>
                                We’ll be donating a percentage of proceeds from
                                mint to a charity that’s aligned with our
                                overall vision: Future charities we donate to
                                will be decided by the community to ensure that
                                everyone is aligned with the cause and we are
                                giving back to the greater community in a huge
                                way.
                                <ul>
                                    <li>
                                        NY PACE (https://www.nypace.org/),
                                        supporting under-represented,
                                        under-resourced entrepreneurs to get
