                ...
                >
                    ...
                    <section className={s.background_planets_head}>
                        <div className={s.container_planets_head}>
                            <div className={s.circle_head_light} />
                        </div>
                    </section>
                    ...
                    <section className={s.background_planets_mission}>
                        <div className={s.container_planets_mission}>
                            ...
                            <div className={s.circle_mission_lg} />
                            <div className={s.circle_mission_sm_first} />
                            <div className={s.circle_mission_second} />
                            <div className={s.circle_mission_third} />
                        </div>
                    </section>
                            ...
                            <div className={s.mission__row}>
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        enthusiasts, and investors. A Solarpunk
                                        utopia powered by BeYu Labs and driven
                                        by radical optimism and sustainability.{" "}
                                    </p>
                                    <p>
                                        A collection of 10,119 crew members,
                                        primed for the genesis mission launch.
                                        On this voyage, crew members will have
                                        access to epic shared experiences,
                                        meaningful collabs, one of a kind NFT
                                        drops, and a future built for the
                                        community over time. With the focus on
                                        empowering Web3 entrepreneurship the
                                        ecosystem will fill the underlying gaps
                                        on contribution with incentivized
                                        exchange of utility. Each of us will
                                        have a role to play.
                                    </p>
                                    <h5 className={s.nexush5}>
                                        Bridging the gap between dream and
                                        reality, virtual and real, we build a
                                        regenerative vision of the future.
                                    </h5>
        ...
        <img src={"/spaceman.svg"} alt='spaceman' />
                    ...
                    <section className={s.background_planets_astromap}>
                        <div className={s.container_planets_astromap}>
                            ...
                            <div className={s.circle_astromap_sm_first} />
                            <div className={s.circle_astromap_second} />
                            <div className={s.circle_astromap_sm_second} />
                            <div className={s.circle_astromap_sm_third} />
                            <div className={s.circle_mission_lg_shine} />
                            <div className={s.circle_astromap_third} />
                            <div className={s.circle_astromap_sm_fourth} />
                            <div className={s.circle_astromap_sm_fifth} />
                            <div className={s.circle_astromap_sm_sixth} />
                            <div className={s.circle_astromap_sm_seventh} />
                            ...
                            <div className={s.circle_astromap_sm_eighth} />
                            <div className={s.circle_astromap_sm_ninth} />
                            <div className={s.circle_astromap_sm_tenth} />
                            <div className={s.circle_astromap_sm_eleventh} />
                            <div className={s.circle_astromap_sm_twelth} />
                        </div>
                    </section>
                        ...
                        <div className='container'>
                            ...
                            >
                                ...
                                <div className={s.cards__list}>
                                    <div
                                        className={cn(s.card, s.left, s.card_1)}
                                    >
                                    ...
                                    <div
                                        className={cn(s.card, s.left, s.card_3)}
                                    >
                                        <div className={s.dot_num}>
                                            <span className={s.dot} />
                                        </div>
                                    ...
                                    <div
                                        className={cn(s.card, s.left, s.card_5)}
                                    >
                                        <div className={s.dot_num}>
                                            <span className={s.dot} />
                                        </div>
                                    ...
                                    <div
                                        className={cn(s.card, s.left, s.card_7)}
                                    >
                                        <div className={s.dot_num}>
                                            <span className={s.dot} />
                                        </div>
                    ...
                    <section className={s.background_planets_boarding}>
                        <div className={s.container_planets_boarding}>
                            ...
                            <div className={s.circle_mission_boarding} />
                        </div>
                    </section>
                        ...
                        <div className='container'>
                            ...
                            >
                                ...
                                <div>
                                    <h2>Boarding Pass</h2>
                                    <h5 className={s.nexush5}>
                                        The Boarding Passes are separated by
                                        their contribution to the new world of
                                        web3. Each character type will have a
                                        unique challenge in order to cultivate a
                                        diverse list of creators . This list
                                        will give you access to the Boarding
                                        Pass NFT and its exclusive perks. Stay
                                        alert and don’t get left behind in the
                                    ...
                                    <p className={s.boardingDescr}>
                                        ...
                                        challenges, they will essentially
                                        guarantee your seat on the rocket to the
                                        new world. These challenges will be
                                        presented sporadically and closed off in
                                        short sprints of time, so stay active in
                                        the Discord to make sure you lock down
                                        your respective boarding pass and don’t
                                        get left behind in the deteriorating
                                        space of Web2.
                                    </p>
                                ...
                                >
                                        ...
                                        >
                                            ...
                                            <div className={s.description}>
                                                <p>
                                                    ...
                                                    harmony to terraform the
                                                    planet in the same direction
                                                    - the founders. The
                                                    captain’s vision is brought
                                                    to life by those to see the
                                                    light at the end of at the
                                                    end of the tunnel.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div className={s.description}>
                                                <p>
                                                    ...
                                                    that come with terraforming
                                                    a new world; they build
                                                    quietly in the back-end and
                                                    help connect the dots to
                                    ...
                                    <SwiperSlide>
                                        ...
                                        >
                                            ...
                                            <div className={s.description}>
                                                <p>
                                                    The creatives that take
                                                    ideas and bring them to life
                                                    in a beautiful way - the
                                                    artists. Without grace in
                                                    the design of a of a new
                                    ...
                                    <SwiperSlide>
                                        ...
                                        >
                                            ...
                                            <div className={s.description}>
                                                <p>
                                                    On a mission to spread ideas
                                                    and share news of
                                                    innovations and creation -
                                                    the marketers. A new
                                                    business - a beautiful piece
                                                    of art - an innovative idea;
                                                    do they really exist if the
                                                    people of the planet don’t
                                                    KNOW they exist? The
                                                    journalists spread the word
                                                    to ensure the population is
                                        ...
                                        >
                                            ...
                                            <div className={s.description}>
                                                <p>
                                                    ...
                                                    the investors. Those who
                                                    decide what the direction of
