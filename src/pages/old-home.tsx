        ...
        <section className="px-6 md:px-4 flex flex-col justify-center items-center mb-52 md:mb-24 xl:mb-72 lg:-ml-40">
          <div className="mt-10 sm:mt-20 md:mt-12 lg:mt-2 ml-24 md:flex-row-reverse flex flex-col items-center z-30">
            <div className="md:w-heroImage h-heroImage mr-16 mt-8 -ml-12">
              <Image alt="Nexus Voyagers" src={'/voyagers-main.svg'} />
            </div>
            <div className="md:w-2/5 mr-16 ml-32 -mt-12">
              ...
              >
                ...
                a member of the <span className="text-nexusGreen">Voyager</span>{' '}
                space{' '}
                <span className="underline decoration-nexusGreen decoration-4 underline-offset-2">
                  {' '}
                  mission
            ...
            <CalloutSection
              ...
              image={
                <div className="p-8 lg:p-0 w-nexusMissionImage h-nexusMissionImage ml-24">
                  <Image src={'/nexus-mission.svg'} alt="Nexus Mission" />
                </div>
              }
              description={
                <div className="pr-6">
            ...
            <CalloutSection
              ...
              image={
                <div className="md:absolute md:scale-110 md:-bottom-4 md:-left-4 lg:-bottom-96 lg:w-ticketsImage h-ticketsImage">
                  <Image src={'/nexus-tickets.svg'} alt="Boarding Pass" />
                </div>
              }
              description={
                <>
                  <div>
                    <p className="mb-5 uppercase font-medium text-lg w-boardingDescription">
                      ...
                      unique challenge in order to ensure you align with that
                      character,and that you will be able to mint them during
                      our presale.
                    </p>
                    <p className="mb-5 font-normal text-left text-lg w-boardingDescription h-boardingDescription leading-8">
                      ...
                      challenges will be presented sporadically and closed off
                      in short sprints of time, so stay active in the Discord to
                      make sure you lock down your respective boarding pass and
