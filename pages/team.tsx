...
const Team: NextPage = () => {
  ...
  return (
    <div className="text-center">
      ...
      <div className="lg:hidden sm:grid grid-cols-1 gap-y-5 justify-center items-start mt-6 sm:w-screen">
        {createAvatarCardsforPhone()}
      </div>
      <button className="lg:hidden sm:flex rounded-lg text-sm justify-center items-center ml-24 inline-block py-2.5 px-8 mb-3 mt-3 bg-transparent border border-solid  border-nexusGreen text-white">
