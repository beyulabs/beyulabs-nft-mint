          ...
          <CalloutSection
            ...
            description={
              <div className="pr-6">
                ...
                <button
                  className="mb-6 md:mb-0 cursor-not-allowed flex flex-row justify-center items-center text-xl rounded-lg text-white bg-gradient-to-r from-nexusGreen to-nexusGradientGreen px-8 py-3 disabled:opacity-50"
                >
